-- ============================================================
-- eSPJ-Kontribusi — Skema Database Supabase (PostgreSQL)
...
--   4. Ambil Project URL & anon key di: Settings -> API
--      lalu isi pada aplikasi (tombol status koneksi di kanan atas)
-- ============================================================
...
-- Aplikasi dipakai internal tanpa login, jadi anon key diberi
-- akses penuh. Jika ingin lebih aman, aktifkan Supabase Auth
-- lalu batasi policy (lihat catatan di bagian bawah).
-- ============================================================
...
-- memegang anon key (sesuai kebutuhan aplikasi internal tanpa
-- login). Bila ingin diperketat, aktifkan Supabase Auth lalu
-- ganti using (true) menjadi, misalnya:
